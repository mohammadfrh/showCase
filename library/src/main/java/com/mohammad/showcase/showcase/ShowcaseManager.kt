...
import com.mohammad.showcase.ui.showcase.ShowcaseActivity
import com.mohammad.showcase.ui.tooltip.ArrowPosition
import com.mohammad.showcase.util.Constants
import com.mohammad.showcase.util.TooltipFieldUtil
import com.mohammad.showcase.util.toRectF

data class ShowcaseManager(
    ...
    class Builder {
        private lateinit var caseCallBack:ShowCaseCallBack
